...
import java.util.Stack;
 ...
 class Expression{
	 ...
	 private String dx;
	 private String x;
	 public String content_dx;
	 public String result;
	 
	 public String[] oo_huajian(String test){
	 ...
	 public String simplify(String content,String x,String int_x) {
	 ...
	 public String derivative(String content,char dx){
	
	//public final String derivative(final String readerin, final char x) { // 求导
